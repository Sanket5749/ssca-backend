...
import { Student, SemesterRecord, AttendanceRecord, Skill, Certification, Project, Extracurricular, Score } from './src/models/index.js';
  ...
  try {
    ...
    for (let i = 0; i < 100; i++) {
      ...
      const student = await Student.create({
        ...
        email: `${name.replace(' ', '.').toLowerCase()}.${prn}@example.com`,
